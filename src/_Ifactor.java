...
*/
public class _Ifactor implements Cloneable, Comparable<_Ifactor>
{
        /**
        ...
        */
        ...
        final public static _Ifactor ONE = new _Ifactor(1) ;

        final public static _Ifactor ZERO = new _Ifactor(0) ;

        /** Constructor given an integer.
        * constructor with an ordinary integer
        * @param number the standard representation of the integer
        */
        public _Ifactor(int number)
        {
        ...
        */
        public _Ifactor(BigInteger number)
        {
                n = number ;
                primeexp = new Vector<Integer>() ;
        ...
        */
        public _Ifactor(Vector<Integer> pows)
        {
        ...
        * @since 2009-08-14
        */
        public _Ifactor clone()
        {
                Vector<Integer> p = (Vector<Integer>)primeexp.clone();
                _Ifactor cl = new _Ifactor(0) ;
        ...
        */
        public boolean equals(final _Ifactor oth)
        {
        ...
        */
        public _Ifactor multiply(final BigInteger oth)
        {
                /* the optimization is to factorize oth _before_ multiplying
                */
                return( multiply(new _Ifactor(oth)) ) ;
        } /* Ifactor.multiply */
        ...
        * @return the product of both numbers.
        */
        public _Ifactor multiply(final int oth)
        {
                /* the optimization is to factorize oth _before_ multiplying
                */
                return( multiply(new _Ifactor(oth)) ) ;
        ...
        * @return the product of both numbers.
        */
        public _Ifactor multiply(final _Ifactor oth)
        {
        ...
        */
        public _Ifactor lcm(final _Ifactor oth)
        {
        ...
        *   if any of both arguments is zero.
        */
        public _Ifactor gcd(final _Ifactor oth)
        {
        ...
        */
        protected _Ifactor multGcdLcm(final _Ifactor oth, int type)
        {
                _Ifactor prod = new _Ifactor(0) ;
        ...
        */
        public _Ifactor divide(final _Ifactor oth)
        {
                ...
                */
                return  new _Ifactor(n.divide(oth.n)) ;
        } /* Ifactor.divide */
        ...
        */
        public _Ifactor pow(final int exponent) throws ArithmeticException
        {
        ...
        * @since 2009-05-18
        */
        public _Rational root(final int r) throws ArithmeticException
        {
                if ( r == 0 )
                ...
                else if ( r < 0 )
                {
                        /* a^(-1/b)= 1/(a^(1/b))
                        */
                        final _Rational invRoot = root(-r) ;
                        return _Rational.ONE.divide(invRoot) ;
                }
                else
                {
                        ...
                        */
                        ...
                        for(int i=0 ; i < primeexp.size() ; i += 2)
                        {
                                ...
                                else
                                {
                                        ...
                                        */
                                        _Ifactor f = new _Ifactor(num.divide(deno)) ;
        ...
        */
        public _Ifactor max(final _Ifactor oth)
        {
        ...
        */
        public _Ifactor min(final _Ifactor oth)
        {
                if( n.compareTo(oth.n) <= 0 )
                        return this ;
                else
        ...
        */
        public static _Ifactor max(final Vector<_Ifactor> set)
        {
                _Ifactor resul = set.elementAt(0) ;
        ...
        */
        public static _Ifactor min(final Vector<_Ifactor> set)
        {
                _Ifactor resul = set.elementAt(0) ;
                for(int i=1; i < set.size() ; i++)
        ...
        * @since 2012-02-15
        */
        public int compareTo( final _Ifactor oth)
        {
        ...
        */
        public static void main(String[] args) throws Exception
        {
                ...
                System.out.println( new _Ifactor(n)) ;
        } /* Ifactor.main */
} /* Ifactor */
