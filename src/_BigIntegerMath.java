...
public class _BigIntegerMath
{
        ...
        */
        ...
        {
                return (new _Ifactor(n.abs())).sigma(k).n ;
        } /* sigmak */
        ...
        */
        ...
        {
                return (new _Ifactor(Math.abs(n))).sigma().n ;
        }
        ...
        */
        ...
        {
                return (new _Ifactor(n.abs())).divisors() ;
        }
        ...
        */
        ...
        {
                return (new _Ifactor(n.abs())).sigma().n ;
        }
        ...
        */
        static public BigInteger core(final BigInteger n)
        {
                if ( n.compareTo(BigInteger.ZERO) < 0 )
                        throw new ArithmeticException("Negative argument "+ n) ;
                final _Ifactor i = new _Ifactor(n) ;
                return i.core() ;
        }
        ...
        * @author Richard J. Mathar
        */
        static public _Rational[] solve(final BigInteger[][]A, final BigInteger[] rhs) throws ArithmeticException
        {
                ...
                if ( rhs.length != rL )
                        ...
                        /* Gauss elimination 
                        */
                        _Rational x[] = new _Rational[rL] ;

                        /* copy of r.h.s ito a mutable Rationalright hand side
                        */
                        for(int c = 0 ; c < cL ; c++)
                                x[c] = new _Rational(rhs[c]) ;
                        ...
                        for(int c = 0 ; c < cL-1 ; c++)
                        {
                                ...
                                for( int r=c+1; r < rL ; r++)
                                {
                                        ...
                                        */
                                        ...
                                        _Rational tmp = x[r].multiply(A[c][c]) .subtract ( x[c].multiply(A[r][c])) ;
                                        x[r] = tmp ;
                                }
                        }
        ...
        */
        static public _Rational centrlFactNumt(int n,int k)
        {
                if ( k > n || k < 0 || ( k % 2 ) != (n % 2) )
                ...
                else
                {
                        ...
                        _Rational jsum = new _Rational(0,1) ;
                        int kprime = n-k ;
                        for ( int j =0 ; j <= kprime ; j++)
                        {
                                _Rational nusum = new _Rational(0,1) ;
                                for(int nu =0 ; nu <= j ; nu++)
                                {
                                        _Rational t = new _Rational(j-2*nu,2) ;
                                        t = t.pow(kprime+j) ;
        ...
        */
        static public _Rational centrlFactNumT(int n,int k)
        {
                ...
                {
                        /* Proposition 2.1 */
                        return centrlFactNumT(n-2,k-2).add( centrlFactNumT(n-2,k).multiply(new _Rational(k*k,4)) ) ;
                }
        } /* CentralFactNumT */
