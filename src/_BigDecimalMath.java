...
"230924783917373501229842420499568935992206602204654941510613");
        ...
        */
        static public BigDecimal sqrt(final BigDecimal x, final MathContext mc)
        {
                ...
                if ( x.abs().subtract( new BigDecimal(Math.pow(10.,-mc.getPrecision())) ).compareTo(BigDecimal.ZERO) < 0 )
                        return _BigDecimalMath.scalePrec(BigDecimal.ZERO,mc) ;
                ...
                */
                ...
                else if ( n == 3)
                {
                        ...
                        */
                        ...
                        _Rational r = new _Rational(7153,524288) ;
                        _Rational pk = new _Rational(7153,524288) ;
                        for(int k=1; ; k++)
                        {
                                _Rational tmp = pk.divide(k) ;
                ...
                else if ( n == 5)
                {
                        ...
                        */
                        ...
                        _Rational r = new _Rational(759,16384) ;
                        _Rational pk = new _Rational(759,16384) ;
                        for(int k=1; ; k++)
                        {
                                _Rational tmp = pk.divide(k) ;
                                if ( tmp.doubleValue() < eps)
                ...
                else if ( n == 7)
                {
                        ...
                        */
                        ...
                        _Rational r = new _Rational(1,8) ;
                        _Rational pk = new _Rational(1,8) ;
                        for(int k=1; ; k++)
                        {
                                _Rational tmp = pk.divide(k) ;
                                if ( tmp.doubleValue() < eps)
        ...
        * @author Richard J. Mathar
        */
        static public BigDecimal log(final _Rational r, final MathContext mc)
        {
                /* the value is undefined if x is negative.
                */
                if ( r.compareTo(_Rational.ZERO) <= 0 )
                        throw new ArithmeticException("Cannot take log of negative "+ r.toString() ) ;
                else if ( r.compareTo(_Rational.ONE) == 0)
                        return BigDecimal.ZERO ;
                else
                {
        ...
        */
        static public BigDecimal powRound(final BigDecimal x, final BigInteger n)
        {
                ...
                */
                if ( n.compareTo(_Rational.MAX_INT) > 0 || n.compareTo(_Rational.MIN_INT) < 0)
        ...
        * @since 2010-05-26
        */
        static public BigDecimal powRound(final BigDecimal x, final _Rational q)
        {
                /** Special cases: x^1=x and x^0 = 1
                */
        ...
        * @since 2010-05-26
        */
        static public BigDecimal Gamma(final _Rational q, final MathContext mc)
        {
                if ( q.isBigInteger() )
                {
                        if ( q.compareTo(_Rational.ZERO) <= 0 )
                                throw new ArithmeticException("Gamma at "+q.toString() ) ;
                        else
                        {
                                /* Gamma(n) = (n-1)! */
                                _Factorial f = new _Factorial() ;
                ...
                else if ( q.b.intValue() == 2 )
                {
                        ...
                        */
                        ...
                        if ( q.compareTo(_Rational.ZERO) >= 0 )
                        {
                                _Rational pro = _Rational.ONE ;
                                _Rational f = q.subtract(1) ;
                                while ( f.compareTo(_Rational.ZERO) > 0 )
                                {
                                        pro = pro.multiply(f) ;
                                        f = f.subtract(1) ;
                                }
        ...
        */
        static public BigDecimal zeta(final int n, final MathContext mc)
        {
                ...
                if( n % 2 == 0 )
                {
                        ...
                        */
                        _Rational b = (new _Bernoulli()).at(n).abs() ;
                        b = b.divide((new _Factorial()).at(n)) ;
                ...
                else
                {
                        ...
                        */
                        _Rational betsum = new _Rational() ;
                        _Bernoulli bern = new _Bernoulli() ;
                        _Factorial fact = new _Factorial() ;
                        for(int npr=0 ; npr <= (n+1)/2 ; npr++)
                        {
                                _Rational b = bern.at(2*npr).multiply(bern.at(n+1-2*npr)) ;
...
1.577721810442023616644432780e-30,7.888609052210118073520537800e-31
        ...
        */
        static protected BigDecimal broadhurstBBP(final int n, final int p, final int a[], MathContext mc)
        {
                ...
                */
                ...
                for(int c =0 ; ; c++)
                {
                        _Rational r = new _Rational() ;
                        for (int k=0; k < 8 ; k++)
                        {
                                _Rational tmp = new _Rational(new BigInteger(""+a[k]),(new BigInteger(""+(1+8*c+k))).pow(n)) ;
                                /* floor( (pk+p)/2)
                                */
        ...
        * @since 2010-07-19
        */
        static public _BigComplex addRound(final _BigComplex x, final BigDecimal y)
        {
                final BigDecimal R = addRound(x.re,y) ;
                return new _BigComplex(R,x.im) ;
        } /* addRound */
        ...
        * @since 2010-07-19
        */
        static public _BigComplex addRound(final _BigComplex x, final _BigComplex y)
        {
                final BigDecimal R = addRound(x.re,y.re) ;
                final BigDecimal I = addRound(x.im,y.im) ;
                return new _BigComplex(R,I) ;
        } /* addRound */
        ...
        * @since 2010-07-19
        */
        static public _BigComplex subtractRound(final _BigComplex x, final _BigComplex y)
        {
        ...
        * @since 2010-07-19
        */
        static public _BigComplex multiplyRound(final _BigComplex x, final BigDecimal y)
        {
        ...
        * @since 2010-07-19
        */
        static public _BigComplex multiplyRound(final _BigComplex x, final _BigComplex y)
        {
        ...
        * @since 2009-07-30
        */
        static public BigDecimal multiplyRound(final BigDecimal x, final _Rational f)
        {
        ...
        * @since 2010-07-19
        */
        static public _BigComplex invertRound(final _BigComplex z)
        {
                if (z.im.compareTo(BigDecimal.ZERO) == 0)
                {
                        ...
                        */
                        ...
                        return new _BigComplex( BigDecimal.ONE.divide( z.re, mc) ) ;
                }
                else if (z.re.compareTo(BigDecimal.ZERO) == 0)
                {
                        ...
                        */
                        ...
                        return new _BigComplex(BigDecimal.ZERO, BigDecimal.ONE.divide( z.im, mc).negate() ) ;
                }
                else 
                {
                        ...
                        */
                        ...
                        return new _BigComplex(R,I.negate()) ;
                }
        }
        ...
        * @since 2010-07-19
        */
        static public _BigComplex divideRound(final _BigComplex x, final _BigComplex y)
        {
        ...
        * @since 2012-03-01
        */
        static public _BigComplex divideRound(final BigInteger n, final _BigComplex x)
        {
                /* catch case of real-valued denominator first
                */
                if ( x.im.compareTo(BigDecimal.ZERO) == 0 )
                        return new _BigComplex( divideRound(n,x.re),BigDecimal.ZERO ) ;
                else if ( x.re.compareTo(BigDecimal.ZERO) == 0 )
                        return new _BigComplex( BigDecimal.ZERO, divideRound(n,x.im).negate() ) ;
                        
                _BigComplex z = invertRound(x) ;
                /* n/(x+iy) = nx/(x^2+y^2) -nyi/(x^2+y^2)       
                */
                BigDecimal repart = multiplyRound(z.re, n) ;
                BigDecimal impart = multiplyRound(z.im, n) ;
                return new _BigComplex( repart, impart) ;
        } /* divideRound */
        ...
        * @return The same value as the input but with increased (pseudo) precision.
        */
        static public _BigComplex scalePrec(final _BigComplex x, int d)
        {
                return new _BigComplex( scalePrec(x.re,d),scalePrec(x.im,d)) ;
        }
