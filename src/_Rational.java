...
*/
public class _Rational implements Cloneable, Comparable<_Rational>
{
        /** numerator
        */
        BigInteger a ;
        ...
        */
        ...
        /** The constant 1.
        */
        static _Rational ONE = new _Rational(1,1) ;
        /** The constant 0.
        */
        static public _Rational ZERO = new _Rational() ;

        /** The constant 1/2
        * @since 2010-05-25
        */
        static public _Rational HALF = new _Rational(1,2) ;
        ...
        */
        public _Rational(BigInteger a, BigInteger b)
        {
                this.a = a ;
                this.b = b ;
                normalize() ;
        ...
        */
        public _Rational(String str) throws NumberFormatException
        {
                this(str,10) ;
        }
        ...
        * Warning: this does not yet test for a denominator equal to zero
        */
        public _Rational(String str, int radix) throws NumberFormatException
        {
        ...
        */
        public _Rational clone()
        {
                ...
                */
                ...
                return new _Rational(aclon,bclon) ;
        } /* Rational.clone */
        ...
        */
        public _Rational multiply(final _Rational val)
        {
        ...
        */
        public _Rational multiply(final BigInteger val)
        {
                _Rational val2 = new _Rational(val,BigInteger.ONE) ;
        ...
        * @return the product of this with the value.
        */
        public _Rational multiply(final int val)
        {
        ...
        */
        public _Rational pow(int exponent)
        {
                if ( exponent == 0 )
                        return new _Rational(1,1) ;
        ...
        * @since 2009-05-18
        */
        public _Rational pow(BigInteger exponent) throws NumberFormatException
        {
                /* test for overflow */
        ...
        * @since 2009-05-18
        */
        public _Rational root(BigInteger r) throws NumberFormatException
        {
                /* test for overflow */
                ...
                */
                _Ifactor num =  new _Ifactor(a.abs()) ;
                _Ifactor deno = new _Ifactor(b) ;
                final _Rational resul = num.root(rthroot).divide( deno.root(rthroot) ) ;
                if ( flipsign)
                        return resul.negate() ;
                else
                        return resul ;
        ...
        * @since 2009-05-18
        */
        public _Rational pow(_Rational exponent) throws NumberFormatException
        {
        ...
        */
        public _Rational divide(final _Rational val)
        {
                if( val.compareTo(_Rational.ZERO) == 0 )
        ...
        * @return the value of this/val
        */
        public _Rational divide(BigInteger val)
        {
        ...
        * @return The value of this/val
        */
        public _Rational divide(int val)
        {
                if( val == 0 )
                        throw new ArithmeticException("Dividing "+ toString() + " through zero.") ;
                _Rational val2 = new _Rational(val,1) ;
                return ( divide(val2)) ;
        } /* Rational.divide */
        ...
        * @return this+val.
        */
        public _Rational add(_Rational val)
        {
        ...
        * @return this+val.
        */
        public _Rational add(BigInteger val)
        {
                _Rational val2 = new _Rational(val,BigInteger.ONE) ;
                return ( add(val2) ) ;
        } /* Rational.add */
        ...
        * @since May 26 2010
        */
        public _Rational add(int val)
        {
                BigInteger val2 = a.add(b.multiply(new BigInteger(""+val))) ;
                return new _Rational(val2,b) ;
        } /* Rational.add */

        /** Compute the negative.
        * @return -this.
        */
        public _Rational negate()
        {
                return ( new _Rational(a.negate(),b) ) ;
        } /* Rational.negate */
        ...
        * @return this - val.
        */
        public _Rational subtract(_Rational val)
        {
                _Rational val2 = val.negate() ;
                return ( add(val2) ) ;
        } /* Rational.subtract */
        ...
        * @return this - val.
        */
        public _Rational subtract(BigInteger val)
        {
                _Rational val2 = new _Rational(val,BigInteger.ONE) ;
        ...
        * @return this - val.
        */
        public _Rational subtract(int val)
        {
                _Rational val2 = new _Rational(val,1) ;
                return ( subtract(val2) ) ;
        } /* Rational.subtract */
        ...
        * @author Richard J. Mathar
        */
        public static _Rational binomial(_Rational n, BigInteger m)
        {
                if ( m.compareTo(BigInteger.ZERO) == 0 ) 
                        return _Rational.ONE ;
                _Rational bin = n ;
        ...
        * @author Richard J. Mathar
        */
        public static _Rational binomial(_Rational n, int m)
        {
                if ( m == 0 ) 
                        return _Rational.ONE ;
                _Rational bin = n ;
        ...
        * @author Richard J. Mathar
        */
        public static _Rational hankelSymb(_Rational n, int k)
        {
                if ( k == 0 ) 
                        return _Rational.ONE ;
                else if ( k < 0)
                        throw new ArithmeticException("Negative parameter "+k) ;
                _Rational nkhalf = n.subtract(k).add(_Rational.HALF) ;
        ...
        */
        public _Rational abs()
        {
                return( new _Rational(a.abs(),b.abs())) ;
        }
        ...
        *    or greater than val.
        */
        public int compareTo(final _Rational val)
        {
        ...
        */
        ...
        {
                final _Rational val2 = new _Rational(val,BigInteger.ONE) ;
        ...
        */
        public BigDecimal BigDecimalValue(MathContext mc)
        {
                ...
                */
                return _BigDecimalMath.scalePrec(n.divide(d,mc),mc) ;
        ...
        * @since 2008-10-19
        */
        public _Rational max(final _Rational val)
        {
                if ( compareTo(val) > 0 )
                        return this;
                else
        ...
        * @since 2008-10-19
        */
        public _Rational min(final _Rational val)
        {
                if ( compareTo(val) < 0 )
                        return this;
                else
        ...
        * @since 2008-10-25
        */
        public _Rational Pochhammer(final BigInteger n)
        {
                ...
                else
                {
                        ...
                        */
                        _Rational res = new _Rational(a,b) ;
        ...
        * @since 2008-11-13
        */
        public _Rational Pochhammer(int n)
        {
        ...
        * @since 2012-03-02
        */
        static public BigInteger lcmDenom(final _Rational[] vals)
        {
                BigInteger l = BigInteger.ONE ;
                for(int v= 0 ; v < vals.length ; v++)
                        l = _BigIntegerMath.lcm(l,vals[v].b) ;
                return l ;
        } /* Rational.lcmDenom */
